import { EncointerCommunity, EncointerMetadata, ParaInclusions } from "../types.js";
import { getApiAt, getApiEncointer, getApiKusama } from "../tools/substrateUtils.js";
 ...
 */
export const getLatestEncointerCeremony = async (block: number): Promise<number> => {
 ...
 */
export const getEncointerBlockNumberFromKusama = async (kusamaBlock: number): Promise<number | null> => {
 ...
 */
export const getCurrentEncointerCommunities = async (block: number): Promise<EncointerCommunity[]> => {
