...
import fs from 'fs';
import { ConvictionVote, EncointerCommunity, QuizSubmission, RNG, VoteConviction, VoteConvictionDragon, VoteConvictionDragonQuiz, VoteConvictionDragonQuizEncointer, VoteConvictionRequirements, Uniqs, ProcessMetadataResult, FetchReputableVotersParams, Bonuses, RewardConfiguration, RewardOption } from "../types.js";
import { getApiAt, getApiKusama, getApiStatemine, getDecimal } from "../tools/substrateUtils.js";
import { getDragonBonusFile } from "../tools/utils.js";
import { cryptoWaitReady } from "@polkadot/util-crypto";
import { createNewCollection } from "./createNewCollection.js";
import { useAccountLocksImpl } from "./accountLocks.js";
import pinataSDK, { PinataClient } from "@pinata/sdk";
import { getConvictionVoting } from "./voteData.js";
import { GraphQLClient } from 'graphql-request';
import { ApiPromise } from "@polkadot/api";
import { getCeremonyAttendants, getCurrentEncointerCommunities, getEncointerBlockNumberFromKusama, getLatestEncointerCeremony, getReputationLifetime } from "./encointerData.js";
